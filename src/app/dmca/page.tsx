...
export const metadata: Metadata = {
  title: "DMCA & Takedown Policy - Yedapo",
  description: "Yedapo DMCA and content takedown policy for content creators",
};
      ...
      <div className="max-w-2xl mx-auto px-4 pt-8 space-y-8">
        ...
        <div className="rounded-lg border border-primary/20 bg-primary/5 p-4">
          <p className="text-sm text-muted-foreground leading-relaxed">
            Yedapo respects the intellectual property rights of content creators. If you believe your
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">How Yedapo Uses Content</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Yedapo generates AI-powered summaries, highlights, and analyses of publicly available
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            Yedapo, please submit a notice containing the following information:
          </p>
          ...
          <div className="rounded-lg border p-4 space-y-3">
            <ol className="list-decimal list-inside space-y-3 text-sm text-muted-foreground">
              ...
              <li>
                <strong className="text-foreground">Identification of the material on Yedapo</strong> that
                you claim is infringing (e.g., the episode page URL on Yedapo, or the specific
