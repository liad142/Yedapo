...
export const PLAN_META: Record<UserPlan, PlanMeta> = {
  free: {
    label: 'Free',
    monthlyPrice: 0,
    description: 'Enough to see what you are missing',
    features: [
  ...
  pro: {
    ...
    badge: 'Most Popular',
    description: 'Stop choosing which episodes deserve your attention',
    features: [
      'Unlimited AI summaries — never hit a wall',
      'Unlimited Ask AI — interrogate every episode',
      'Unlimited podcast & YouTube follows',
      'Full transcripts with instant search',
      'Highlights, counterpoints & complete shownotes',
      'Auto-delivery to email, Telegram, or WhatsApp',
      'Daily or weekly digest — summaries come to you',
      'Choose your delivery schedule',
      'Export summaries to Notion, docs, anywhere',
