...
import { Loader2, Sparkles, FileText, Lightbulb, ListMusic, Scale, Play, ChevronDown, ChevronsUpDown, ChevronsDownUp, Quote, Lock, Copy, Check, Share2, Info } from "lucide-react";
      ...
      <div className="pb-28 space-y-10 max-w-3xl mx-auto px-4 md:px-0">
        ...
        {summaryReady && (
          <div className="flex items-start gap-2 text-xs text-muted-foreground px-1">
            ...
            <p>This summary was generated by AI and may contain inaccuracies. It does not represent the views of the original creators.</p>
          </div>
        )}
